...
JFrame f;
    ...
    private void initComponents() {
        ...
        Wishcombo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "NULL", "Happy birthday to my idiot friend who is still a kid at heart. Lots of happy returns of the day.", "Happy birthday friend, lets continue doing all the stupid things we do together for life.", "Happy birthday, we grew up together doing crazy things and now its time to do bigger ones." }));
        ...
        IMG.add(TP);
        TP.setBounds(30, 240, 230, 150);

        Image.setIcon(new javax.swing.ImageIcon("C:\\Users\\umang\\OneDrive\\Pictures\\HMT010.jpg")); // NOI18N
        IMG.add(Image);
        Image.setBounds(0, 0, 293, 410);
