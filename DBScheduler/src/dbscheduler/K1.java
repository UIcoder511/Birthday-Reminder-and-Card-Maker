...
public class K1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 420, -1, -1));
        ...
        IMG.add(TP);
        TP.setBounds(90, 90, 420, 90);

        Image.setIcon(new javax.swing.ImageIcon("C:\\Users\\umang\\OneDrive\\Pictures\\K1.jpg")); // NOI18N
        IMG.add(Image);
        Image.setBounds(0, 0, 590, 410);

        getContentPane().add(IMG, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 590, 410));
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 0, 40, -1));
...
this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(K1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
